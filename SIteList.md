...
## 📚👻 I write some small short stuff related JavaScript
- [Demo](https://www.ekaprasetia.com/)
- [Repository](https://github.com/ekaone/Blog)

## 🧾✈ Headless CMS by Contentful with Gatsby JS
- [Demo](https://dazzling-leakey-5997d0.netlify.app/)
- [Repository](https://github.com/ekaone/Gatsby-Contentful)

## 📙🔖 Sanity Headless CMS and Gatsby simple Blog
- [Demo](https://sanity-gatsby-blog-web-zseqtj6f.netlify.app/)
- [Repository](https://github.com/ekaone/Sanity-Gatsby-Blog)

## 👨‍👩‍👧🤼 Web for Indonesia Community in Next.js 
- [Demo](https://nextjs.id/)
- [Repository](https://github.com/ekaone/Website-NextJS-ID)

## 🌟🌈 Play on and some collection of Chakra UI Components 
- [Demo](https://ekaone.github.io/Play-ChakraUI/)
- [Repository](https://github.com/ekaone/Play-ChakraUI)

## 🚦🚉 Simple Wizard with React Hook Form with React Redux 
- [Demo](https://ekaone.github.io/React-Hook-Form-Wizard/)
- [Repository](https://github.com/ekaone/React-Hook-Form-Wizard)

## 📕🧾 Play around React and Storybook that useful for UI component development tool 
- [Demo](https://ekaone.github.io/Play-Storybook/)
- [Repository](https://github.com/ekaone/Play-Storybook)

## 🗺🌎 Easy map with Leaflet and OpenStreetMap, this is bootstrapped gatsby-starter-leaflet 
- [Demo](https://ekaone.github.io/Gatsby-Leaflet/)
- [Repository](https://github.com/ekaone/Gatsby-Leaflet)

## 🛐🌿 Play mocking API with Mirage JS
